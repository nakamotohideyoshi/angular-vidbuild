export const environment = {
  ...
  debounceTime: 400,
  firebase: {
    apiKey: "AIzaSyDMRkYGEeHb0x8dgN7k6nvCwgiGMfVGGl8",
    authDomain: "vidbuild-prod-6fbe5.firebaseapp.com",
    databaseURL: "https://vidbuild-prod-6fbe5.firebaseio.com",
    projectId: "vidbuild-prod-6fbe5",
    storageBucket: "vidbuild-prod-6fbe5.appspot.com",
    messagingSenderId: "487278825601"
  },
  getty: {
